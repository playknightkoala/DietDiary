...
export function LoginScreen() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(160deg, #EDF2E6 0%, #F4F1EA 55%, #E8EEE0 100%)', padding: 24 }}>
