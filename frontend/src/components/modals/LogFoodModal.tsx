                ...
                {pages.map((p, i) =>
                  p.kind === 'photo' ? (
                    ...
                    <button
                      ...
                      onClick={() => setPageIdx(i)}
                      title="無照片的食物項目"
                      style={{ flex: 'none', width: 58, height: 58, borderRadius: 12, border: i === curIdx ? '2.5px solid #4A7C59' : '1.5px solid #E4DFD2', background: '#F0EDE3', color: '#8A9284', fontSize: 11.5, fontWeight: 700, cursor: 'pointer', padding: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 3, lineHeight: 1 }}
                    >
