...
export function ModalShell({ children, maxWidth, cardStyle }: { children: ReactNode; maxWidth: number; cardStyle?: CSSProperties }) {
  return (
    <div style={{ position: 'fixed', inset: 0, background: 'rgba(45,59,45,.4)', zIndex: 50, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16 }}>
      <div
        style={{
