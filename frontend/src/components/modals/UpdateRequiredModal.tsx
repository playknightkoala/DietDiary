...
export function UpdateRequiredModal() {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, background: 'rgba(45,59,45,.55)', zIndex: 100, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16 }}>
      <div style={{ background: '#fff', borderRadius: 22, width: '100%', maxWidth: 380, padding: 26, textAlign: 'center', boxShadow: '0 24px 60px rgba(45,59,45,.3)', display: 'flex', flexDirection: 'column', gap: 14, animation: 'popIn .25s ease both' }}>
