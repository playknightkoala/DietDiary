...
import { aiOcrSchema, aiCommentSchema, aiDailySchema, aiFeedbackSchema, aiInbodySchema, aiResearchSchema, FOOD_KEYS } from '../validation.js';
import {
  ENTRY_COLS,
  createComment,
  currentAiBody,
...
// ---- 辨識 InBody 報告照片：擷取檢測日期與身體組成數值，供自動記錄與前後比較 ----
...
aiRouter.post('/inbody', async (req, res) => {
